...
static inline _Bool bennet_domain_ownership_is_top_uintptr_t(
...
static inline _Bool bennet_domain_ownership_is_bottom_uintptr_t(
    struct bennet_domain_ownership_uintptr_t *cs) {
  return cs->bottom;
}
static inline _Bool bennet_domain_ownership_leq_uintptr_t(
...
static inline _Bool bennet_domain_ownership_equal_uintptr_t(
    struct bennet_domain_ownership_uintptr_t *cs1,
    struct bennet_domain_ownership_uintptr_t *cs2) {
  if (cs1->bottom && cs2->bottom) {
    return 1;
